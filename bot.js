...
client.on('message', (message) => {
  if (message.content === "smart fridges should be able to scream") {
    ...
    message.channel.send({embed: {"title":"💸 Buy Fridge+/Ghost Fridge","description":"Thanks for choosing to financially support Fridgebot! There are three premium subscriptions: Fridge+ if you want to personalize Fridgebot, Ghost Fridge if you want a completely custom bot, and Fridge ∞, a big bundle of 5 instances of Fridge+, and 5 instances of Ghost Fridge.","fields":[{"name":"Subscribe","value":"Fridge+ costs 2$ a month\nGhost Fridge costs 3$ a month\nFridge ∞ costs 5$ a month\n[Learn more](https://gumroad.com/l/fridgeplus)"}],"footer":{"text":"✔️ Your payment will be securely processed by Gumroad"},"image":{"url":"https://i.ibb.co/2jrzh2P/Fridge-Illustration.png"}}});
  }else if(message.content === "join fridge land"){
    message.channel.send("Fridge Land is a server for fridge fans and people who want to hang out. Come on in!\nhttps://discord.gg/zPeNPeb");
  }
});
